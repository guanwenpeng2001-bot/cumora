...
const STALE_RESUME_RE = new RegExp([
  ...
  // zcode-acp-server: "Session is not active" (backend session gone; not in the generic "not found" set)
...
function sandboxedEngineMessage(installed: readonly EngineId[]): string {
  return [
    ...
    'Kimi, Grok, Cursor, OpenCode, pi, Gemini, Qwen, Antigravity, ZCode, and native-Windows Claude currently lack',
...
function helpText(): string {
  return [
    ...
    'Agent, OpenCode, pi, Gemini, Qwen, Antigravity, ZCode, and native-Windows Claude require the explicit',
